        ...
        <CardBody>
          <StyledCardContentInner>
            ...
            <RabbitRowSmall>
              <RabbitBoxSmall>
                <CardImageFirst>
                  <Image src="/images/sign bunny 1@2x.png" alt="Number 1" width={200} height={200} />
                </CardImageFirst>
              </RabbitBoxSmall>
              <RabbitBoxSmall>
                <CardImage style={{ marginLeft: '-1.2em' }}>
                  <Image src="/images/sign bunny 2@2x.png" alt="Number 2" width={200} height={200} />
                </CardImage>
              </RabbitBoxSmall>
              <RabbitBoxSmall>
                <CardImage style={{ marginLeft: '-1.2em' }}>
                  <Image src="/images/sign bunny 3@2x.png" alt="Number 3" width={200} height={200} />
                </CardImage>
              </RabbitBoxSmall>
              <RabbitBoxSmall>
                <CardImage style={{ marginLeft: '-1.2em' }}>
                  <Image src="/images/sign bunny 4@2x.png" alt="Number 4" width={200} height={200} />
                </CardImage>
              </RabbitBoxSmall>
            </RabbitRowSmall>
            <Column>

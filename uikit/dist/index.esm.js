import React, { isValidElement, cloneElement, useContext, Children, forwardRef, useRef, useEffect, useState, useMemo, useReducer, useCallback, createContext } from 'react';
import styled, { keyframes, css, useTheme, ThemeContext, ThemeProvider, createGlobalStyle } from 'styled-components';
...
var Icon$r = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React.createElement("img", { src: "/images/10.png", alt: "" })));
};
...
var RotatingPancakeIcon = styled(Icon$r)(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
...
var Logo$2 = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 160 52" }, props),
        React.createElement("image", { width: "160", height: "52", href: isDark ? "/images/LogoTextNewDark.png" : "/images/LogoTextNewWhite.png" })));
};
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React.createElement(PriceLink, { href: "https://exchange.pancakeswap.finance/#/swap?outputCurrency=0xb3a95bdbe4ac65b0628db1e6600f71ed59b89255", target: "_blank" },
        React.createElement(Icon$W, { width: "24px", mr: "8px" }),
        React.createElement(Text, { color: "#02acf3", bold: true }, "$" + cakePriceUsd.toFixed(3)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
...
var LangSelector = function (_a) {
    ...
    return (React.createElement(Dropdown, { position: "top-right", target: React.createElement(Button, { variant: "text", startIcon: React.createElement(Icon$1a, { color: "textSubtle", width: "24px" }) },
            React.createElement(Text, { color: "#02acf3" }, currentLang === null || currentLang === void 0 ? void 0 : currentLang.toUpperCase())) }, langs.map(function (lang) { return (React.createElement(MenuButton, { key: lang.locale, fullWidth: true, onClick: function () { return setLang(lang); }, 
        // Safari fix
